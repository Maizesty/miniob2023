...
std::string table_text_file(const char *base_dir, const char *table_name, const char *atrr_name){
  return std::string(base_dir) + common::FILE_PATH_SPLIT_STR + table_name + "-" + atrr_name + TABLE_Text_SUFFIX;
}